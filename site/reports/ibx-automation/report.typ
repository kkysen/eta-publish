...
#show: report.with(
  ...
  warnings: (
    ...
    [style: #raw("3-minute") is #raw("3 min") in MTA style, with no hyphen: #raw("...f city center, offering about 3-minute frequencies on a lengthy trun...")],
    ...
    [style: #raw("5-minute") is #raw("5 min") in MTA style, with no hyphen: #raw("...time and the currently stated 5-minute peak headways. If peak headwa...")],
    ...
    [style: #raw("1-min") is #raw("1 min") in MTA style, with no hyphen: #raw("...frequencies, like the extreme 1-min headways of Lille to the more...")],
    [style: #raw("2-min") is #raw("2 min") in MTA style, with no hyphen: #raw("... Lille to the more normal 1.5-2-min minimum technical headways of...")],
    ...
    [style: #raw("600-foot") is #raw("600 ft") in MTA style, with no hyphen: #raw("...equire the high capacity of a 600-foot subway train. Since most IBX ...")],
    ...
    [style: #raw("32-min") is #raw("32 min") in MTA style, with no hyphen: #raw("With a 32-min runtime, 2-min turns, and a 9...")],
    [style: #raw("2-min") is #raw("2 min") in MTA style, with no hyphen: #raw("With a 32-min runtime, 2-min turns, and a 90% utilization ...")],
    [style: #raw("2-min") is #raw("2 min") in MTA style, with no hyphen: #raw("... fleet cost. But this is with 2-min peak headways, not 5-min peak...")],
    [style: #raw("5-min") is #raw("5 min") in MTA style, with no hyphen: #raw("...with 2-min peak headways, not 5-min peak headways. And with a 92%...")],
