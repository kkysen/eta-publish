...
#show: report.with(
  ...
  warnings: (
    ...
    [style: #raw("125th Street") should be #raw("125 St") in MTA style: #raw("...cond Avenue Subway’s proposed 125th Street extension to avoid extraneous...")],
    [style: #raw("8 minutes") should be #raw("8 min"): #raw("...l city. SkyTrain runs every 6-8 minutes off-peak on each of two branc...")],
    ...
    [style: #raw("Fordham Road") should be #raw("Fordham Rd") in MTA style: #raw("...ircumferential routes such as Fordham Road in the Bronx and Main Street ...")],
    [style: #raw("Main Street") should be #raw("Main St") in MTA style: #raw("...Fordham Road in the Bronx and Main Street in Queens are appropriate to ...")],
    ...
    [style: #raw("66 seconds") should be #raw("66 sec"): #raw("...rains, but it runs them every 66 seconds, and can run up to 60 seconds...")],
    [style: #raw("60 seconds") should be #raw("60 sec"): #raw("...66 seconds, and can run up to 60 seconds. While a light metro can be a...")],
    [style: #raw("1-min") should be #raw("1 min"), with no hyphen: #raw("...frequencies, like the extreme 1-min headways of Lille to the more...")],
    [style: #raw("2-min") should be #raw("2 min"), with no hyphen: #raw("... Lille to the more normal 1.5-2-min minimum technical headways of...")],
    [style: #raw("2 minutes") should be #raw("2 min"): #raw("...sist) at very high frequency (2 minutes apart or less), trading per-t...")],
    [style: #raw("600-foot") should be #raw("600-ft"): #raw("...equire the high capacity of a 600-foot subway train. Since most IBX ...")],
    [style: #raw("2 minutes") should be #raw("2 min"): #raw("...trains as frequently as every 2 minutes or less thus benefits the pla...")],
    [style: #raw("600-foot") should be #raw("600 ft"), with no hyphen: #raw("...equire the high capacity of a 600-foot subway train. Since most IBX ...")],
