...
#show: report.with(
  ...
  warnings: (
    ...
    [style: #raw("8 minutes") is #raw("8 min"): #raw("...l city. SkyTrain runs every 6-8 minutes off-peak on each of two branc...")],
    [style: #raw("6 minutes") is #raw("6 min"): #raw("...Copenhagen Metro runs every 4-6 minutes off-peak on each of two branc...")],
    [style: #raw("3-minute") is #raw("3-min"): #raw("...f city center, offering about 3-minute frequencies on a lengthy trun...")],
    [style: #raw("6 minutes") is #raw("6 min"): #raw("...ss VAL technology run every 3-6 minutes off-peak in Lille, Rennes, To...")],
    [style: #raw("15 minutes") is #raw("15 min"): #raw("...Marseille Metro runs every 10-15 minutes.")],
    [style: #raw("3-minute") is #raw("3 min"), with no hyphen: #raw("...f city center, offering about 3-minute frequencies on a lengthy trun...")],
    ...
    [style: #raw("5-minute") is #raw("5-min"): #raw("...time and the currently stated 5-minute peak headways. If peak headwa...")],
    [style: #raw("2 minutes") is #raw("2 min"): #raw("... peak headways are reduced to 2 minutes instead, with off-peak headwa...")],
    [style: #raw("3 minutes") is #raw("3 min"): #raw("...ff-peak headways ranging from 3 minutes midday to 5 minutes in the ev...")],
    [style: #raw("5 minutes") is #raw("5 min"): #raw("...ging from 3 minutes midday to 5 minutes in the evening, ridership ris...")],
    [style: #raw("5-minute") is #raw("5 min"), with no hyphen: #raw("...time and the currently stated 5-minute peak headways. If peak headwa...")],
    [style: #raw("66 seconds") is #raw("66 sec"): #raw("...rains, but it runs them every 66 seconds, and can run up to 60 seconds...")],
    [style: #raw("60 seconds") is #raw("60 sec"): #raw("...66 seconds, and can run up to 60 seconds. While a light metro can be a...")],
    [style: #raw("1-min") is #raw("1 min"), with no hyphen: #raw("...frequencies, like the extreme 1-min headways of Lille to the more...")],
    [style: #raw("2-min") is #raw("2 min"), with no hyphen: #raw("... Lille to the more normal 1.5-2-min minimum technical headways of...")],
    [style: #raw("2 minutes") is #raw("2 min"): #raw("...sist) at very high frequency (2 minutes apart or less), trading per-t...")],
    [style: #raw("600-foot") is #raw("600-ft"): #raw("...equire the high capacity of a 600-foot subway train. Since most IBX ...")],
    [style: #raw("2 minutes") is #raw("2 min"): #raw("...trains as frequently as every 2 minutes or less thus benefits the pla...")],
    [style: #raw("600-foot") is #raw("600 ft"), with no hyphen: #raw("...equire the high capacity of a 600-foot subway train. Since most IBX ...")],
    [style: #raw("180 meters") is #raw("180 m"): #raw("... on the New York City Subway (180 meters) or longer exclusively use hi...")],
    [style: a sentence should end with 1 space, not 2: #raw("...t costs are given separately).··This is a Buy America cost, wh...")],
    [style: #raw("32-min") is #raw("32 min"), with no hyphen: #raw("With a 32-min runtime, 2-min turns, and a 9...")],
    [style: #raw("2-min") is #raw("2 min"), with no hyphen: #raw("With a 32-min runtime, 2-min turns, and a 90% utilization ...")],
    [style: #raw("2-min") is #raw("2 min"), with no hyphen: #raw("... fleet cost. But this is with 2-min peak headways, not 5-min peak...")],
    [style: #raw("5-min") is #raw("5 min"), with no hyphen: #raw("...with 2-min peak headways, not 5-min peak headways. And with a 92%...")],
    [style: #raw("72,000 lbs") is #raw("72,000 lb"): #raw("weight: 72,000 lbs per 65 ft AW0 car")],
    [style: #raw("72,000 lbs") is #raw("72,000 lb"): #raw("AW0 weight/length: 72,000 lbs / 65 ft = 1648 kg/m")],
    [style: #raw("175 lbs") is #raw("175 lb"): #raw("AW0 weight/length: (232 t - (175 lbs * 780)) / (19.05 m * 4) = 223...")],
  ),
)
