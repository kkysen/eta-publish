...
- style: `5 minutes` is `5 min`: `...ld, and cost riders more than 5 minutes every trip before ever steppi...`
- style: `5 minutes` is `5 min`: `...ld, and cost riders more than 5 minutes every trip before ever steppi...`
...
- style: `130 feet` is `130 ft`: `...with stations between 100 and 130 feet beneath the surface. Accordin...`
- style: `5 minutes` is `5 min`: `...escalator transfer times over 5 minutes.`
...
- style: `8 minutes` is `8 min`: `...normal walking pace, it takes 8 minutes to travel from GCM’s lower me...`
- style: `10 minutes` is `10 min`: `... to GCT’s Main Concourse, and 10 minutes to reach the 4/5/6 trains. Gi...`
- style: `15 minutes` is `15 min`: `...ven that it only takes around 15 minutes to travel between Penn Statio...`
- style: `3.5 minutes` is `3.5 min`: `...subway lines along the route: 3.5 minutes at Lenox Av via escalators, 5...`
- style: `5.1 minutes` is `5.1 min`: `...s at Lenox Av via escalators, 5.1 minutes at St Nicholas Av via escalat...`
- style: `5.1 minutes` is `5.1 min`: `...cholas Av via escalators, and 5.1 minutes at Broadway via elevators. Th...`
- style: `5 minutes` is `5 min`: `...escalator transfer times over 5 minutes.`
- style: `7 minutes` is `7 min`: `...posed design, this would take 7 minutes on escalators). Conversely, S...`
- style: `Second Ave subway` is `Second Avenue Subway` in MTA style: `... even by the standards of the Second Ave subway. `
- style: `30 seconds` is `30 sec`: `... platform or mezzanine within 30 seconds, which, while certainly nice ...`
- style: `6 inches` is `6 in`: `...its ventilation openings only 6 inches above roadway height, obviati...`
...
- style: `5 minutes` is `5 min`: `...tchbacks that would take over 5 minutes to reach the platform. Transf...`
- style: `2.1 minutes` is `2.1 min`: `... escalators, only take 1.6 to 2.1 minutes for transfers in the feasibil...`
- style: `19 seconds` is `19 sec`: `...se 198 ft to the Blue Line in 19 seconds, door closing to door opening...`
