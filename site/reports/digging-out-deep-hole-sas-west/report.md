...
- style: `5 minutes` is `5 min`, which is how a report writes a measurement: `...ld, and cost riders more than 5 minutes every trip before ever steppi...`
- style: `5 minutes` is `5 min`, which is how a report writes a measurement: `...ld, and cost riders more than 5 minutes every trip before ever steppi...`
...
- style: `130 feet` is `130 ft`, which is how a report writes a measurement: `...with stations between 100 and 130 feet beneath the surface. Accordin...`
- style: `5 minutes` is `5 min`, which is how a report writes a measurement: `...escalator transfer times over 5 minutes.`
...
- style: `8 minutes` is `8 min`, which is how a report writes a measurement: `...normal walking pace, it takes 8 minutes to travel from GCM’s lower me...`
- style: `10 minutes` is `10 min`, which is how a report writes a measurement: `... to GCT’s Main Concourse, and 10 minutes to reach the 4/5/6 trains. Gi...`
- style: `15 minutes` is `15 min`, which is how a report writes a measurement: `...ven that it only takes around 15 minutes to travel between Penn Statio...`
- style: `3.5 minutes` is `3.5 min`, which is how a report writes a measurement: `...subway lines along the route: 3.5 minutes at Lenox Av via escalators, 5...`
- style: `5.1 minutes` is `5.1 min`, which is how a report writes a measurement: `...s at Lenox Av via escalators, 5.1 minutes at St Nicholas Av via escalat...`
- style: `5.1 minutes` is `5.1 min`, which is how a report writes a measurement: `...cholas Av via escalators, and 5.1 minutes at Broadway via elevators. Th...`
- style: `5 minutes` is `5 min`, which is how a report writes a measurement: `...escalator transfer times over 5 minutes.`
- style: `7 minutes` is `7 min`, which is how a report writes a measurement: `...posed design, this would take 7 minutes on escalators). Conversely, S...`
- style: `Second Ave subway` is `Second Avenue Subway` in MTA style: `... even by the standards of the Second Ave subway. `
- style: `30 seconds` is `30 sec`, which is how a report writes a measurement: `... platform or mezzanine within 30 seconds, which, while certainly nice ...`
- style: `6 inches` is `6 in`, which is how a report writes a measurement: `...its ventilation openings only 6 inches above roadway height, obviati...`
...
- style: `5 minutes` is `5 min`, which is how a report writes a measurement: `...tchbacks that would take over 5 minutes to reach the platform. Transf...`
- style: `2.1 minutes` is `2.1 min`, which is how a report writes a measurement: `... escalators, only take 1.6 to 2.1 minutes for transfers in the feasibil...`
- style: `19 seconds` is `19 sec`, which is how a report writes a measurement: `...se 198 ft to the Blue Line in 19 seconds, door closing to door opening...`
...
On paper, the [MTA’s proposed extension of the Second Avenue Subway (SAS) west across 125th Street](<https://www.mta.info/document/196361>)<sup>\[2\]</sup> (SAS West) should be a slam dunk.
...
It is designed to replace buses that, even though they are slower than walking, still carry [over 25,000 riders per day](<https://reorientations.medium.com/where-should-nyc-build-brt-8d9dd852fc72#dbaf>)<sup>\[3\]</sup>.
...
[Credit: MTA](<https://www.mta.info/document/196361#page=5>)<sup>\[4\]</sup>
...
To put it in context, on a per-mile basis, SAS West is projected to be 1.4 times[^1] the inflation-adjusted cost of the Second Ave Subway’s first phase, a project that itself was already [by far the most expensive subway line in the world](<https://www.nytimes.com/2017/12/28/nyregion/new-york-subway-construction-costs.html>)<sup>\[5\]</sup>.
It would clock in at seven times the currently projected per-mile cost of Los Angeles’ new [D Line extension](<https://www.nbclosangeles.com/news/local/los-angeles-metro-d-line-opening/3888138/>)<sup>\[6\]</sup>, a project that itself has suffered badly from the [American transit cost explosion](<https://transitcosts.com/>)<sup>\[7\]</sup>.
To compare to a project across the Atlantic, the [Grand Paris Express](<https://www.grandparisexpress.fr/benefit-metro-ile-de-france>)<sup>\[8\]</sup> is currently building 125 miles of new rail lines and 68 stations, [90% of it underground](<https://www.herrenknecht.com/en/references/referencesdetail/grand-paris-express/>)<sup>\[9\]</sup>, for $530 million per mile.
This means that the MTA is currently projecting the 125 St subway to cost 12 times per mile[^2] what Paris has been able to achieve.
...
According to the [MTA’s feasibility study](<https://www.mta.info/document/196361>)<sup>\[2\]</sup>, one-way escalator rides will take up to five minutes.
...
[Credit: MTA](<https://www.mta.info/document/196361#page=30>)<sup>\[10\]</sup>
...
Indeed, its projected [daily ridership of 163,900](<https://www.mta.info/document/196361#page=13>)<sup>\[11\]</sup> already surpasses that of the Interborough Express (IBX), which is projected to carry [160,000 riders](<https://www.mta.info/press-release/icymi-governor-hochul-announces-interborough-express-advancing-planning-active-phase#:~:text=ridership%20projections%20to-,160%2C000%20per%20day,-%2C%20up%2050%2C000%20from>)<sup>\[12\]</sup> across 18 stations.
...
As its [recent projects show](<https://nypost.com/2012/08/21/blasting-at-2nd-ave-construction-site-blows-out-windows/>)<sup>\[13\]</sup>, this approach does [little to quiet neighborhood opposition](<https://nypost.com/2011/09/27/second-ave-subway-dust-harmless-says-mta/>)<sup>\[14\]</sup> while substantially raising the cost of construction.
Last but not least, while there have been many [proclamations of huge cost savings on projects like SAS Phase 2](<https://www.mta.info/press-release/icymi-governor-hochul-celebrates-groundbreaking-major-construction-stage-of-second>)<sup>\[15\]</sup>, to date none of these have actually reduced the final price tag of the project in question.
...
When it comes to building underground, every cubic foot of excavation increases the bill, and [every additional foot of depth not only raises the cost](<https://transitcosts.com/wp-content/uploads/TCP_Final_Report.pdf#page=209>)<sup>\[16\]</sup> but forever increases station access time.
...
So many design decisions require carefully weighing trade-offs, but building a shallower subway isn’t one of them—doing so is cheaper *and* better.
...
In part as a result of this cost, what was originally envisioned in 1929 as a six-track mainline running the length of Manhattan—and which was most recently reinvisioned as a line from 63 St to 125 St, the so-called “Second Avenue Stubway”—only made it three stops and two miles to 96 St. Cost escalations during planning and construction even forced further cuts, including [eliminating](<http://www.capitalnewyork.com/article/politics/2012/12/6785265/no-seoul-style-platform-doors-new-york-subways-even-new-stations>)<sup>\[17\]</sup> [platform screen doors from Phase 1](<https://www.nytimes.com/2007/04/05/nyregion/05doors.html>)<sup>\[18\]</sup> and [postponing CBTC installation until Phase 2](<https://www.transit.dot.gov/sites/fta.dot.gov/files/2025-10/PMOC-Comprehensive-Monitoring-Report-NY-SAS-08-2025_0.pdf#page=32>)<sup>\[19\]</sup> at the cost of safety and reliability.
...
- **Deep-mined stations purporting to reduce surface impact.** Rather than dig up the entire street to build shallow cut-and-cover stations, for both 72 St and 86 St, only access shafts were built to the surface, while the rest of the station caverns were mined. While this procedure might have promised to reduce surface impacts on paper, it did little to quell neighborhood anger, as [many residents complained](<https://nypost.com/2011/09/27/second-ave-subway-dust-harmless-says-mta/>)<sup>\[14\]</sup> bitterly about blasting noise, narrowed sidewalks, and construction walls. Construction still required blocks-long on-street staging areas, which for many residents were functionally indistinguishable from a construction pit. It also took longer. Surface impact needs to be measured in both time and area; taking less street space but for longer can be more disruptive overall. If staging areas and construction pits are in practice equally disruptive, then the argument for quicker construction methods becomes even stronger.
...
[Credit: MTA](<https://www.flickr.com/photos/mtaphotos/8475914281/in/album-72157632775809340>)<sup>\[24\]</sup>
<!-- [Image Source](<https://www.flickr.com/photo_download.gne?id=8475914281&secret=4efa092c06&size=o&source=photoPageEngagement>): -->

In no small part because of this complex, deep design, GCM wound up wildly over budget, exploding from [$4.3 to $11 billion and more than 14 years behind schedule](<https://www.newsday.com/long-island/east-side-access-tour-1.18020231>)<sup>\[25\]</sup>.
More importantly for the final project, GCM’s depth has significantly impacted its utility to travelers.
The terminal has never lived up to ridership expectations, in large part because [most riders don't see any major time improvement from traveling to GCM](<https://www.thelirrtoday.com/2026/01/esa-hasnt-reduced-travel-times.html>)<sup>\[26\]</sup> compared with using Penn Station or Hunterspoint Avenue and the 7 train.
At a normal walking pace, it takes 8 minutes to travel from GCM’s lower mezzanine to GCT’s Main Concourse, and 10 minutes to reach the 4/5/6 trains[^4].
...
According to current plans, the stations will be built incredibly deep: [120 ft at Lenox Av](<https://www.mta.info/document/196361#page=26>)<sup>\[27\]</sup>, [130 ft at St Nicholas Av](<https://www.mta.info/document/196361#page=28>)<sup>\[1\]</sup>, and [100 ft at Broadway](<https://www.mta.info/document/196361#page=30>)<sup>\[10\]</sup>.
...
What’s more, to minimize surface disruption, these stations will be mined using the extremely expensive [sequential excavation method (SEM)](<https://www.mta.info/document/196361#page=23>)<sup>\[28\]</sup>.

Excessive depth also creates excessive transfer times to the various subway lines along the route: [3.5 minutes](<https://www.mta.info/document/196361#page=26>)<sup>\[27\]</sup> at Lenox Av via escalators, [5.1 minutes](<https://www.mta.info/document/196361#page=28>)<sup>\[1\]</sup> at St Nicholas Av via escalators, and [5.1 minutes](<https://www.mta.info/document/196361#page=30>)<sup>\[10\]</sup> at Broadway via elevators.
...
[Credit: MTA](<https://www.mta.info/document/196361#page=28>)<sup>\[1\]</sup>
...
The ground is [“loose sand and gravel, with some softer clay and silt,”](<https://www.mta.info/document/196361#page=16>)<sup>\[29\]</sup> with groundwater only 10–20 ft deep, unlike the hard Manhattan schist of Phase 1.
...
Luckily, however, the [variable-density shielded slurry TBMs](<https://www.governor.ny.gov/sites/default/files/2025-08/Presentation_2025-08-15_SAS2_NOTES_SCRUBBED.pdf#page=24>)<sup>\[30\]</sup> already selected for Phase 2 line the tunnel as they dig, and are perfect for digging tunnels even in the watery, sandy conditions located close to the surface.

By contrast, when it comes to station construction, mining a [sequential excavation method (SEM)](<https://www.mta.info/document/196361#page=23>)<sup>\[28\]</sup> cavern in loose sand with running water is difficult, with a high risk of the walls and ceiling caving in.
...
Modern cut-and-cover construction, commonly referred to as the [Milan method](<https://www.konstructia.com/post/how-to-build-an-metro-station-en#:~:text=In%20the%20Milan%20method%2C%20walls,the%20construction%20of%20such%20facilities.>)<sup>\[31\]</sup> and pioneered in Milan’s metro, is effective even with a high water table.
...
In high-water table conditions, diaphragm walls are typically used for more [cost-effective prevention of water ingress](<https://archive.org/details/slurrywallsasstr0000xant/page/34/mode/2up>)<sup>\[32\]</sup>.
...
The 106 St Phase 2 station, [37 ft deep](<https://www.mta.info/document/179396#page=6>)<sup>\[33\]</sup>, will be built cut-and-cover and includes [underpinning nearby buildings](<https://www.mta.info/document/131306#page=25>)<sup>\[34\]</sup>.
At 116 St, only [39 ft deep](<https://www.mta.info/document/179396#page=6>)<sup>\[33\]</sup>, the agency recently opted to build a mezzanine below the existing tunnel, only accessible via off-street elevators.
...
This is puzzling since designers shrank the planned mezzanine, [reducing the need for cut-and-cover](<https://www.mta.info/document/75876#page=3>)<sup>\[35\]</sup>.
And at 125 St/Lexington Av, they deepened the station a [further 20 ft](<https://www.mta.info/document/179396#page=36>)<sup>\[36\]</sup> to avoid any impacts and any need to underpin existing foundations.
...
Construction of Xuefu Hospital station in Shenzhen, China, for example, saw noise impacts [no higher than 83 dB](<https://www.mdpi.com/2075-5309/14/6/1678>)<sup>\[37\]</sup>, with most measurement sites on the edge of the construction site reporting significantly lower values.
This is within the bounds [set in the SAS Phase 1 EIS](<https://www.mta.info/document/22201#page=12>)<sup>\[38\]</sup> of no higher than 85 dB.
Variations on construction staging methodology can be used to further reduce costs and surface disruption: Kire station in Osaka, for example, used temporary walls composed of steel piles closer to the surface, [permitting diaphragm wall construction to occur underground](<https://archive.org/details/slurrywallsasstr0000xant/page/658/mode/2up>)<sup>\[39\]</sup> without disrupting traffic and with lower noise impacts.
...
[Credit: MTA](<https://www.mta.info/document/196361#page=18>)<sup>\[41\]</sup>
...
Zhongsheng station on Nanjing Metro Line 7 (a busy station with [40,000 daily riders](<https://mp.weixin.qq.com/s/nJyWc3B0LYJPGPE1Up5iCA>)<sup>\[42\]</sup>) was built cut-and-cover only [2 ft beneath](<https://mp.weixin.qq.com/s/4l7RbnS01yLp1p2Zdee_yA#:~:text=%E5%87%80%E8%B7%9D%E4%BB%85-,0.6m,-%EF%BC%8C%E8%80%83%E8%99%91%E6%97%A2%E6%9C%89%E7%AB%99>)<sup>\[43\]</sup> the existing Line 10 station in [watery sand](<https://mp.weixin.qq.com/s/4l7RbnS01yLp1p2Zdee_yA#:~:text=%E5%9B%BD%E5%86%85%E6%89%BF%E5%8E%8B-,%E5%AF%8C%E6%B0%B4%E7%A0%82%E5%B1%82,-%E4%B8%AD%E9%A6%96%E6%AC%A1%E8%AE%BE%E8%AE%A1>)<sup>\[44\]</sup>.
[Settlement was limited to 2.9 mm (0.11 in)](<https://mp.weixin.qq.com/s/SBoJE69QTtuc8mzZgKiWwQ>)<sup>\[45\]</sup> through [ground freezing](<https://mp.weixin.qq.com/s/E93D6tELgYmRYaiNY6hhAw>)<sup>\[46\]</sup>, a [technique already used in SAS Phase 1](<https://urbanny.com/project/mta-second-avenue-subway-tunneling-structural-geotechnical/#:~:text=despite%20numerous%20borings.-,Ground%20freezing,-was%20determined%20as>)<sup>\[47\]</sup>.
For comparison, the [maximum allowed settlement in historic sections of Rome](<https://transitcosts.com/wp-content/uploads/Italian_Case_Study.pdf#page=120>)<sup>\[48\]</sup>, with priceless monuments from Antiquity like the Colosseum, is 3 mm (0.12 in).
Similarly, the city-center Yuyuan Garden station on Shanghai Line 14 was built only [4 ft beneath](<https://mp.weixin.qq.com/s/fE7l03P3F4j28NoO6eoegA#:~:text=10%E5%8F%B7%E7%BA%BF%EF%BC%8C-,%E5%9E%82%E7%9B%B4%E8%B7%9D%E7%A6%BB1.2%E7%B1%B3,-%E3%80%82>)<sup>\[49\]</sup> Line 10, and Jing’an Temple station on Shanghai Metro Line 14 used [rectangular pipe-jacking](<https://mp.weixin.qq.com/s/R7QkLaX_Mt3iPXfBini8rw>)<sup>\[50\]</sup> and [thixotropic mud](<https://mp.weixin.qq.com/s/R7QkLaX_Mt3iPXfBini8rw#:~:text=%E6%96%B0%E5%9E%8B%E5%87%8F%E6%91%A9-,%E8%A7%A6%E5%8F%98%E6%B3%A5,-%E6%B5%86%E5%92%8C%E7%9B%B8%E5%BA%94>)<sup>\[51\]</sup> to [limit settlement to only 0.2-0.6 in](<https://mp.weixin.qq.com/s/R7QkLaX_Mt3iPXfBini8rw#:~:text=%E6%8E%A7%E5%88%B6%E5%9C%A8%2D-,15%EF%BD%9E5%20mm,-%E3%80%82>)<sup>\[52\]</sup>, with both being in watery soft soil and clays.

![Cross-section of Zhongsheng station.](<images/img-f5b8dae7.jpg>)\
Cross-section of Zhongsheng station.\
[Credit: China Railway Sixth Survey and Design Institute Group Co., Ltd.](<https://mmbiz.qpic.cn/mmbiz_jpg/R3QIfMDE0S8gZDEZoDp8r03hqSf32rQ8sC8poo18ZicPdd2e3RCMhCgKibrXHdwWEibmd29jWrRWxpgE8hf25f9FA/>)<sup>\[53\]</sup>
<!-- [Image Source](<https://mmbiz.qpic.cn/mmbiz_jpg/R3QIfMDE0S8gZDEZoDp8r03hqSf32rQ8sC8poo18ZicPdd2e3RCMhCgKibrXHdwWEibmd29jWrRWxpgE8hf25f9FA/>)<sup>\[53\]</sup>: -->
...
[Credit: Wu Liecheng et al., Shanghai Tunnel Engineering Co., Ltd.](<https://mmbiz.qpic.cn/mmbiz_png/ZHDc6XLp5hBdZC053hhqPT42S3vG38tCIgluQfqJmxdOIARqrQMFiaFWFeX6MNEhx8mibVnB36mrTicQicNA5Jzh0Q/>)<sup>\[54\]</sup>
<!-- [Image Source](<https://mmbiz.qpic.cn/mmbiz_png/ZHDc6XLp5hBdZC053hhqPT42S3vG38tCIgluQfqJmxdOIARqrQMFiaFWFeX6MNEhx8mibVnB36mrTicQicNA5Jzh0Q/>)<sup>\[54\]</sup>: -->
...
Underpinning should be much less of a concern at Broadway (1), as a [172 ft-wide](<https://en.wikipedia.org/wiki/125th_Street_station_(IRT_Broadway%E2%80%93Seventh_Avenue_Line)#:~:text=The%20arch%20measures-,172%20feet,-(52%C2%A0m)%20long>)<sup>\[57\]</sup> [viaduct arch](<https://www.google.com/maps/@40.8155549,-73.9580419,3a,75y,303.51h,90.96t/data=!3m7!1e1!3m5!1s435DcOmetEdoxLraSju-2Q!2e0!6shttps:%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fcb_client%3Dmaps_sv.tactile%26w%3D900%26h%3D600%26pitch%3D-0.9596236859238161%26panoid%3D435DcOmetEdoxLraSju-2Q%26yaw%3D303.5128416340331!7i16384!8i8192!5m1!1e2?entry=ttu&g_ep=EgoyMDI2MDEyMS4wIKXMDSoASAFQAw%3D%3D>)<sup>\[58\]</sup> spans 125 St, 2–3x the width of the station box.
...
Another set of related techniques for building shallow underground tunnels and stations with minimal surface disruption are the cellular arch method (CAM) and the tubular roof construction method (TRCM), both of which have been used in [Seoul](<https://m.blog.naver.com/PostView.naver?blogId=krriblog&logNo=220778326895&proxyReferer=https:%2F%2Fwww.google.com%2F&trackingCode=external>)<sup>\[59\]</sup> and [Busan](<https://www.issmge.org/uploads/publications/6/20/2014_075.pdf>)<sup>\[60\]</sup>, South Korea and [Milan](<https://www.rocksoil.com/pdf/118_r.pdf>)<sup>\[61\]</sup>, Italy.
...
![Station length as a percentage of platform length.](<images/img-44bf278f.png>)\
Station length as a percentage of platform length.\
Credit: ETA
<!-- SVG: TODO -->
...
The nearly 10-story ventilation structure at 69 St and 2 Av on SAS Phase 1.\
...
China has heavily used Western and Japanese standards in its rapid development, and its fire code for subway stations follows NFPA 130; Turkey, which has very low construction costs, uses NFPA 130 as well; Spain, long famous for its low construction costs, uses a lightly modified version of NFPA 130.[^10]
...
And it could store them on the steep tracks as well,[^13] even if it’s not ideal.
...
<!-- [Image Source](<https://www.flickr.com/photo_download.gne?id=4490800374&secret=db20eed4be&size=o&source=photoPageEngagement>): -->
...
1. <https://www.mta.info/document/196361#page=28> (archived [May 18, 2026](<https://web.archive.org/web/20260518003215id_/https://www.mta.info/document/196361#page=28>))
2. <https://www.mta.info/document/196361> (archived [May 18, 2026](<https://web.archive.org/web/20260518003215/https://www.mta.info/document/196361>))
3. <https://reorientations.medium.com/where-should-nyc-build-brt-8d9dd852fc72#dbaf> (archived [October 9, 2025](<https://web.archive.org/web/20251009140800/https://reorientations.medium.com/where-should-nyc-build-brt-8d9dd852fc72#dbaf>))
4. <https://www.mta.info/document/196361#page=5> (archived [May 18, 2026](<https://web.archive.org/web/20260518003215id_/https://www.mta.info/document/196361#page=5>))
5. <https://www.nytimes.com/2017/12/28/nyregion/new-york-subway-construction-costs.html> (archived [January 1, 2026](<https://web.archive.org/web/20260101035028/https://www.nytimes.com/2017/12/28/nyregion/new-york-subway-construction-costs.html>))
6. <https://www.nbclosangeles.com/news/local/los-angeles-metro-d-line-opening/3888138/> (archived [May 10, 2026](<https://web.archive.org/web/20260510213240/https://www.nbclosangeles.com/news/local/los-angeles-metro-d-line-opening/3888138/>))
7. <https://transitcosts.com/> (archived [September 8, 2026](<https://web.archive.org/web/20260908151059/https://transitcosts.com/>))
8. <https://www.grandparisexpress.fr/benefit-metro-ile-de-france> (archived [September 2, 2026](<https://web.archive.org/web/20260902074507/https://www.grandparisexpress.fr/benefit-metro-ile-de-france>))
9. <https://www.herrenknecht.com/en/references/referencesdetail/grand-paris-express/> (archived [March 13, 2026](<https://web.archive.org/web/20260313051852/https://www.herrenknecht.com/en/references/referencesdetail/grand-paris-express/>))
10. <https://www.mta.info/document/196361#page=30> (archived [May 18, 2026](<https://web.archive.org/web/20260518003215id_/https://www.mta.info/document/196361#page=30>))
11. <https://www.mta.info/document/196361#page=13> (archived [May 18, 2026](<https://web.archive.org/web/20260518003215id_/https://www.mta.info/document/196361#page=13>))
