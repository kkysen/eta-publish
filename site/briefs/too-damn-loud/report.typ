...
#show: report.with(
  ...
  warnings: (
    ...
    [style: #raw("10 minutes") is #raw("10 min") in MTA style: #raw("... Flushing-Main St, and nearly 10 minutes out of a 40 minute ride compr...")],
    [style: #raw("40 minute") is #raw("40 min") in MTA style: #raw("...nd nearly 10 minutes out of a 40 minute ride comprised announcements....")],
    [style: #raw("15 seconds") is #raw("15 sec") in MTA style: #raw("... the door closing warning—are 15 seconds per interstation segment, onl...")],
