...
- style: `10 minutes` is `10 min`, which is how a report writes a measurement: `... Flushing-Main St, and nearly 10 minutes out of a 40 minute ride compr...`
- style: `40 minute` is `40 min`, which is how a report writes a measurement: `...nd nearly 10 minutes out of a 40 minute ride comprised announcements....`
- style: `15 seconds` is `15 sec`, which is how a report writes a measurement: `... the door closing warning—are 15 seconds per interstation segment, onl...`
