...
- style: `10 minutes` is `10 min` in MTA style: `... Flushing-Main St, and nearly 10 minutes out of a 40 minute ride compr...`
- style: `40 minute` is `40 min` in MTA style: `...nd nearly 10 minutes out of a 40 minute ride comprised announcements....`
- style: `15 seconds` is `15 sec` in MTA style: `... the door closing warning—are 15 seconds per interstation segment, onl...`
